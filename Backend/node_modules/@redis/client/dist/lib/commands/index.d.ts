...
declare const _default: {
    ...
    readonly DELEX: {
        readonly IS_READ_ONLY: false;
        readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, key: import("../RESP/types").RedisArgument, options?: {
    ...
    readonly MSETEX: {
        readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, keyValuePairs: import("./MSET").MSetArguments, options?: {
            expiration?: ({
                type: "EX";
                value: number;
            } | {
